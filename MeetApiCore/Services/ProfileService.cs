...
public class ProfileService : IProfileService
{
    ...
    public ProfileService(AppDbContext db,
        IUsersDataService usersDataService, ICitiesDataService citiesDataService,
        IHobbiesDataService hobbiesDataService)
    {
        _db = db;
    ...
    public void UpdateProfile(string userId, ProfileFormToServer profileFormToServer)
    {
        ...
        if (profileFormToServer.Location != null)
            user.Location = _citiesDataService.GetAllCities()
                .FirstOrDefault(x => x.Name == profileFormToServer.Location);
        if (profileFormToServer.Gender != null &&
            (profileFormToServer.Gender == "M" || profileFormToServer.Gender == "F"))
