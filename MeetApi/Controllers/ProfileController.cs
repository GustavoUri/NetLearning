...
//
//     public ProfileController(UserManager<User> userManager, SignInManager<User> signInManager, AppDbContext db)
//     {
...
//         if (user != null)
//         {
//             var profile = new ProfileFormToServer();
